sap.ui.define([
		...
		function getFrameUrl (sHash, sUrlParameters) {
			var sUrl = jQuery.sap.getResourcePath("com/cozumevi/fiori_smartview/app", ".html");
		...
		return Opa5.extend("com.cozumevi.fiori_smartview.test.integration.pages.Common", {
			...
			getMockServer : function () {
				return new Promise(function (success) {
					Opa5.getWindow().sap.ui.require(["com/cozumevi/fiori_smartview/localService/mockserver"], function (mockserver) {
